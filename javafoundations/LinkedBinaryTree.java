...
public class LinkedBinaryTree<T> implements BinaryTree<T>
{
 ...
 /**
  * @ author: sarah may
  * @return int Count of leafs in LBT 
  */
 public int countLeaves(){
	 
    if(root == null ) // if the root is null
      return 0; // there are no leaves  
    // if the root has no children
    
    if( root.getLeft() == null && root.getRight() == null ) { 
      return 1; // there is only one leaf 
      
    } else {
    	// call recursive method for left subtree and right subtree
    	// add and return 
  ...
  * helper method
  * @ author: sarah may
  * @param el a subtree in the LBT
  * @return int Count of leafs in subtree 
  */
 private int countLeaves(BTNode<T> el){
	 
    if(el == null ) // if the element is null (though this should never happen)
      return 0; // no more leaves -- end recursion 
    
    // if the element has no children 
    if( el.getLeft() == null && el.getRight() == null ) {
      return 1; // there is only one more leaf -- end recursion 
      
    } else {
    	// call recursive method for left subtree and right subtree
    	// add and return
      return countLeaves(el.getLeft()) + countLeaves(el.getRight());
    }
  }
}
